#undef ORIENTEDCAPSULEEDITOR_API
...
#define UE_PROJECT_NAME EditorScripting
#define UE_TARGET_NAME EditorScriptingEditor
...
#define ORIENTEDCAPSULEEDITOR_API DLLEXPORT
